      ...
      <Navbar fixedTop>
        ...
        <Navbar.Collapse>
          <div className="top-navigation">
            <Nav>
              <NavItem eventKey={1} href="https://twitter.com/code4africa" target="_blank">WASILIANA</NavItem>
              <OverlayTrigger trigger="click" placement="bottom" overlay={<EmbedPopup />} rootClose={true}>
                <NavItem eventKey={2} href="#">PACHIKA HII <i className="fa fa-caret-down" aria-hidden="true"></i></NavItem>
              </OverlayTrigger>
...
class EmbedPopup extends Component {
  ...
  render() {
    return (
      <Popover id="popover-positioned-bottom" title="Pachika kifaa hichi" {...this.props}>
